 **☀️ wttr - реалізація консольного додатку для роботи з wttr. питає у користувача назву міста та повертає дані - назва міста (або найближче до нього), температуру в Цельсіях, опис та іконку у вигляді емоджи.**
